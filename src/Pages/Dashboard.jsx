...
export default function Dashboard({ children }) {
  ...
  const { userData,loading,error} = useSelector((state) => state.customer);
  //console.log("customer state", loading, error, userData);
                ...
                <div className="relative z-10 max-w-screen-xl px-4  pb-20 pt-10 sm:py-24 mx-auto sm:px-6 lg:px-8">
                    <div className="max-w-xl sm:mt-1 mt-80 space-y-8 text-center sm:text-right sm:ml-auto">
                        <h2 className="text-xl font-bold sm:text-4xl ">
                            Get Started Now
                            <span className="hidden sm:block text-sm font-mono">Online Milk Management System with <br></br><b><i>Sri Vayusena Dairy Farm</i></b></span>
                        </h2>
